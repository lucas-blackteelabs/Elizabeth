    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className="bg-[hsl(25,16%,17%)] border-[hsl(25,10%,25%)]">
            ...
            <CardContent>
              <CalendarComponent
                ...
                selected={date}
                onSelect={setDate}
                className="rounded border border-[hsl(25,10%,25%)]"
              />
            </CardContent>
          </Card>
        </div>
        ...
        <div>
          <Card className="bg-[hsl(25,16%,17%)] border-[hsl(25,10%,25%)]">
            <CardHeader>
              <CardTitle className="font-heading text-[hsl(30,25%,90%)] text-base">
              ...
              <div className="space-y-4">
                {date?.getDate() === 17 ? (
                  ...
                  <div className="flex items-start space-x-3 pb-3 border-b border-[hsl(25,10%,23%)]">
                    ...
                    <div>
                      <p className="font-body font-medium text-[hsl(30,25%,90%)]">Support Group</p>
                      <p className="text-sm text-[hsl(28,15%,58%)] font-body">Community Center</p>
                ...
                <Button variant="outline" className="w-full border-[hsl(25,10%,29%)] text-[hsl(28,18%,65%)] hover:bg-primary/10 hover:text-gold hover:border-gold/30 font-body">
                  <PlusCircle className="h-4 w-4 mr-2" />
                  Add Event
                </Button>
              </div>
