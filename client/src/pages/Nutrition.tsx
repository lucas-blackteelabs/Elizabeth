      ...
      <Tabs defaultValue="recipes">
        ...
        <TabsContent value="recipes">
          <div className="mb-4 flex justify-between items-center">
            <h2 className="text-lg font-heading text-[hsl(25,30%,28%)]">Anti-Inflammatory Recipes</h2>
            <div className="flex gap-2">
              <Button variant="outline" size="sm" className="border-[hsl(30,22%,85%)] text-[hsl(25,20%,42%)] hover:bg-primary/10 hover:text-gold font-body">Filter</Button>
              <Button size="sm" className="bg-gold text-[hsl(0,0%,100%)] hover:bg-gold/90 font-body">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {["Turmeric Roasted Vegetables", "Ginger Salmon Bowl", "Berries & Yogurt Parfait", "Mediterranean Salad", "Avocado Toast", "Green Smoothie"].map((title, index) => (
              <Card key={index} className="bg-[hsl(36,40%,98%)] border-[hsl(30,25%,87%)] overflow-hidden hover:border-gold/20 transition-all duration-300">
                <div className="w-full h-40 bg-gradient-to-br from-primary/20 to-[hsl(30,30%,93%)] flex items-center justify-center">
        ...
        <TabsContent value="meal-plan">
          <Card className="bg-[hsl(36,40%,98%)] border-[hsl(30,25%,87%)]">
            ...
            <CardContent>
              ...
              <Button className="mx-auto block bg-gold text-[hsl(0,0%,100%)] hover:bg-gold/90 font-heading">Generate Meal Plan</Button>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="shopping">
          <Card className="bg-[hsl(36,40%,98%)] border-[hsl(30,25%,87%)]">
            ...
            <CardContent>
              ...
              <Button className="mx-auto block bg-gold text-[hsl(0,0%,100%)] hover:bg-gold/90 font-heading">Generate Shopping List</Button>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
