      ...
      <div className="grid md:grid-cols-3 gap-6 mb-6">
          ...
          <CardContent>
            ...
            <Dialog open={testResultsOpen} onOpenChange={setTestResultsOpen}>
              <DialogTrigger asChild>
                <Button variant="outline" className="w-full border-[hsl(30,8%,25%)] text-[hsl(35,15%,65%)] hover:bg-primary/10 hover:text-gold hover:border-gold/30 font-body">Upload Test Results</Button>
              </DialogTrigger>
              <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto bg-[hsl(30,10%,11%)] border-[hsl(30,8%,20%)]">
                <DialogHeader>
                  <DialogTitle className="font-heading text-gold">Upload Test Results</DialogTitle>
                  <DialogDescription className="text-[hsl(35,10%,55%)] font-body">
                    Add medical test results to track your health progress
                  </DialogDescription>
                  <DialogClose className="absolute top-4 right-4 text-[hsl(35,10%,55%)]">
                    <X className="h-4 w-4" />
                  </DialogClose>
                </DialogHeader>
                <TestResultsUpload />
        ...
        <Card className="bg-[hsl(30,10%,11%)] border-[hsl(30,8%,20%)]">
          ...
          <CardContent>
            ...
            <Button variant="outline" className="w-full border-[hsl(30,8%,25%)] text-[hsl(35,15%,65%)] hover:bg-primary/10 hover:text-gold hover:border-gold/30 font-body">Add Medication</Button>
          </CardContent>
        </Card>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3 pb-3 border-b border-[hsl(30,8%,18%)]">
                ...
                <div>
                  ...
                  <p className="text-xs text-[hsl(35,10%,45%)] font-body">9:30 AM - 10:30 AM</p>
                </div>
              </div>
              <Button variant="outline" className="w-full border-[hsl(30,8%,25%)] text-[hsl(35,15%,65%)] hover:bg-primary/10 hover:text-gold hover:border-gold/30 font-body">View All Appointments</Button>
            </div>
          </CardContent>
        </Card>
      </div>
