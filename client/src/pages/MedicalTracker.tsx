...
export default function MedicalTracker() {
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      >
        <Button className="bg-gold text-[hsl(25,20%,13%)] hover:bg-gold/90 font-heading tracking-wide">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-6">
          ...
          <CardContent>
            ...
            <Dialog open={testResultsOpen} onOpenChange={setTestResultsOpen}>
              <DialogTrigger asChild>
                <Button variant="outline" className="w-full border-[hsl(25,10%,29%)] text-[hsl(28,18%,65%)] hover:bg-primary/10 hover:text-gold hover:border-gold/30 font-body">Upload Test Results</Button>
              </DialogTrigger>
              <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto bg-[hsl(25,16%,17%)] border-[hsl(25,10%,25%)]">
                <DialogHeader>
                  <DialogTitle className="font-heading text-gold">Upload Test Results</DialogTitle>
                  <DialogDescription className="text-[hsl(28,15%,58%)] font-body">
                    Add medical test results to track your health progress
                  </DialogDescription>
                  <DialogClose className="absolute top-4 right-4 text-[hsl(28,15%,58%)]">
                    <X className="h-4 w-4" />
                  </DialogClose>
                </DialogHeader>
                <TestResultsUpload />
        ...
        <Card className="bg-[hsl(25,16%,17%)] border-[hsl(25,10%,25%)]">
          ...
          <CardContent>
            ...
            <Button variant="outline" className="w-full border-[hsl(25,10%,29%)] text-[hsl(28,18%,65%)] hover:bg-primary/10 hover:text-gold hover:border-gold/30 font-body">Add Medication</Button>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[hsl(25,16%,17%)] border-[hsl(25,10%,25%)]">
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-start space-x-3 pb-3 border-b border-[hsl(25,10%,23%)]">
              ...
              <Button variant="outline" className="w-full border-[hsl(25,10%,29%)] text-[hsl(28,18%,65%)] hover:bg-primary/10 hover:text-gold hover:border-gold/30 font-body">View All Appointments</Button>
            </div>
          </CardContent>
        </Card>
      </div>
