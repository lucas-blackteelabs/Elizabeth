...
const ALL_WIDGETS: WidgetDef[] = [
  ...
  { id: "healingStreak", label: "Healing Streak", description: "Consecutive days of wellness activities", icon: <Flame className="h-4 w-4" />, defaultVisible: true },
  ...
  { id: "aiAssistant", label: "AI Health Assistant", description: "Quick access to personalised guidance", icon: <MessageCircle className="h-4 w-4" />, defaultVisible: true },
...
function TumourResponseWidget({ userId }: { userId: number }) {
