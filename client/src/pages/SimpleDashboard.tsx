      ...
      <div className="p-6">
        <div className="flex justify-center items-center h-64">
          <div className="text-center">
            ...
            <p className="text-[hsl(35,10%,55%)] font-body">Loading your dashboard...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="p-6 lg:p-8">
      <div className="mb-8">
        ...
        <h1 className="text-3xl lg:text-4xl font-heading font-bold text-[hsl(40,20%,92%)] tracking-wide">
          Welcome back, {user?.displayName || 'Friend'}
        </h1>
        <p className="text-[hsl(35,10%,50%)] font-body mt-2">Continue nurturing your path to wellness</p>
        <div className="mt-4 h-px bg-gradient-to-r from-gold/40 via-primary/30 to-transparent" />
      </div>
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <Card className="bg-[hsl(30,10%,11%)] border-[hsl(30,8%,20%)] overflow-hidden">
          ...
          <CardContent>
            <div className="space-y-3 mb-6">
              <div className="flex justify-between items-center py-2 border-b border-[hsl(30,8%,18%)]">
                <span className="text-[hsl(35,10%,55%)] font-body text-sm">Cancer Type</span>
                <span className="text-[hsl(40,20%,88%)] font-body font-medium">{user?.cancerType || "Not specified"}</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-[hsl(30,8%,18%)]">
                <span className="text-[hsl(35,10%,55%)] font-body text-sm">Stage</span>
                <span className="text-[hsl(40,20%,88%)] font-body font-medium">{user?.cancerStage || "Not specified"}</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-[hsl(35,10%,55%)] font-body text-sm">Diagnosis Date</span>
                <span className="text-[hsl(40,20%,88%)] font-body font-medium">{user?.diagnosis_date || "Not specified"}</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="bg-primary/15 border border-primary/30 p-3 rounded text-center">
                ...
                <p className="text-xs text-[hsl(35,10%,55%)] font-body">Appointments</p>
              </div>
              <div className="bg-primary/15 border border-primary/30 p-3 rounded text-center">
                <p className="font-heading font-bold text-gold text-xl">7</p>
                <p className="text-xs text-[hsl(35,10%,55%)] font-body">Activities</p>
              </div>
              <div className="bg-primary/15 border border-primary/30 p-3 rounded text-center">
                <p className="font-heading font-bold text-gold text-xl">12</p>
                <p className="text-xs text-[hsl(35,10%,55%)] font-body">Meals</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                <Button variant="outline" size="sm" className="text-xs border-[hsl(30,8%,25%)] text-[hsl(35,15%,65%)] hover:bg-primary/10 hover:text-gold hover:border-gold/30 font-body">
                  Nutrition Tips
                </Button>
                <Button variant="outline" size="sm" className="text-xs border-[hsl(30,8%,25%)] text-[hsl(35,15%,65%)] hover:bg-primary/10 hover:text-gold hover:border-gold/30 font-body">
                  Stress Relief
              ...
              <Button 
                className="w-full bg-gold text-[hsl(30,15%,7%)] hover:bg-gold/90 font-heading tracking-wide glow-gold" 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card className="bg-[hsl(30,10%,11%)] border-[hsl(30,8%,20%)]">
          <CardHeader className="pb-3">
            <CardTitle className="flex items-center gap-2 text-lg font-heading text-[hsl(40,20%,88%)]">
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between text-sm font-body">
                <span className="text-[hsl(35,10%,55%)]">Weekly Goals</span>
                <span className="font-medium text-gold">4/7</span>
              </div>
              <div className="w-full bg-[hsl(30,8%,18%)] rounded-full h-2">
        ...
        <Card className="bg-[hsl(30,10%,11%)] border-[hsl(30,8%,20%)]">
          ...
          <CardContent>
            <div className="space-y-1 font-body">
              <p className="font-medium text-[hsl(40,20%,88%)]">Oncology Checkup</p>
              <p className="text-sm text-[hsl(35,10%,55%)]">Dr. Sarah Thompson</p>
        ...
        <Card className="bg-[hsl(30,10%,11%)] border-[hsl(30,8%,20%)]">
          ...
          <CardContent>
            <div className="text-center">
              ...
              <p className="text-sm text-[hsl(35,10%,55%)] font-body mt-1">Keep up the great work!</p>
            </div>
          </CardContent>
        </Card>
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {quickLinks.map((link) => (
            <Link key={link.href} href={link.href}>
              <Card className="bg-[hsl(30,10%,11%)] border-[hsl(30,8%,20%)] hover:border-gold/30 hover:bg-[hsl(30,10%,13%)] transition-all duration-300 cursor-pointer group">
                <CardContent className="p-4 text-center">
                  ...
                  <h3 className="font-heading text-sm text-[hsl(40,20%,88%)] group-hover:text-gold transition-colors">{link.label}</h3>
                  <p className="text-xs text-[hsl(35,10%,50%)] font-body mt-1">{link.desc}</p>
                </CardContent>
              </Card>
            </Link>
          ))}
      ...
      <Card className="bg-[hsl(30,10%,11%)] border-[hsl(30,8%,20%)]">
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-[hsl(30,8%,18%)] pb-3">
              <div>
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-[hsl(35,10%,55%)] font-body">9:30 AM</p>
              </div>
            </div>
            <div className="flex items-center justify-between pb-3">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-[hsl(35,10%,55%)] font-body">2:00 PM</p>
              </div>
            </div>
          </div>
        </CardContent>
